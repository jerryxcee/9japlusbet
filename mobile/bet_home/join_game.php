                                    ...
                                    <li style=" margin-bottom: -20px;">
                                        <div class="match-item list-item" style=" background-color: transparent;">
                                            ...
                                            if (isset($_POST['join_game'])) {
                                              ...
                                              $arr = str_split('1234567890ABCDEFGHIJKLMNOPQRXTUVWXYZ');
                                              shuffle($arr);
                                              ...
                                              if ($stake_amount <> $ros[5]) {
                                                ?>
                                                  <div style="text-align: center; color: red;">
                                                  <?php
                                                    echo "sorry, you must join with the exert amount this game was created with.";
                                                  ?>
                                                  </div>
                                                  <?php
                                                  exit();
                                            ...
                                            $good = mysql_query("INSERT INTO join_game(id, username, game_palyed, possible_outcome, stake_amount, game_id, join_pin, game_ava_id)VALUES('','$username','$team_played','$possible_outcome','$stake_amount','$ros[0]','$join_pin','$ros[7]')") or die(mysql_error());
                                              ...
                                              <?php
                                                echo "You have joined this game ";
                                              ?>
                                              </span>
                                                         ...
                                                         <tr> 
                                                          ...
                                                          <tr>  
                                                            ...
                                                            <label for="exampleInputPassword1">Stake amount</label>
                                                               <div class="form-group">
                                                                  <input type="number" id="inputText" placeholder="Amount" value="<?php echo "$ros[5]"; ?>" class="form-control input-sm" name="stake_amount" required="">
                                                                </div>
                                                            </td>
                                                        </tr>
